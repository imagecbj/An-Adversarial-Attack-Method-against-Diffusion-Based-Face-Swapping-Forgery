...
def face_detection_mask(src_img, save_dir, max_size, device):
    ...
    # mask
    # landmark_path = "/home/lab/workspace/works/cyx/faceshield-main/utils/shape_predictor_68_face_landmarks.dat"
    ...
    # save_png(f"{save_dir}/land_mask(cropped)", land_mask.unsqueeze(0))
